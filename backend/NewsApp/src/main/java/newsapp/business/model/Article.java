...
public class Article implements Serializable {
	 ...
	 */
	public void setORM_Channel(Channel value) {
		this.channel = value;
	}
	
	private Channel getORM_Channel() {
		return channel;
	}
	...
	@Transient	
	public final CommentSetCollection _comments = new CommentSetCollection(this, _ormAdapter, ORMConstants.KEY_ARTICLE__COMMENTS, ORMConstants.KEY_COMMENT_ARTICLE, ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	@Transient	
	public final CategorySetCollection _categories = new CategorySetCollection(this, _ormAdapter, ORMConstants.KEY_ARTICLE__CATEGORIES, ORMConstants.KEY_MUL_MANY_TO_MANY);
