...
public class ChannelDAO {
	...
	public static Channel loadChannelByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Channel) session.load(Channel.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Channel getChannelByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Channel) session.get(Channel.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Channel loadChannelByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Channel) session.load(Channel.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Channel getChannelByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Channel) session.get(Channel.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(Channel channel) throws PersistentException {
		try {
	...
	public static boolean delete(Channel channel) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(Channel channel)throws PersistentException {
		try {
			Article[] l_articless = channel._articles.toArray();
	...
	public static boolean deleteAndDissociate(Channel channel, org.orm.PersistentSession session)throws PersistentException {
		try {
			Article[] l_articless = channel._articles.toArray();
			for(int i = 0; i < l_articless.length; i++) {
				l_articless[i].setChannel(null);
	...
	public static boolean refresh(Channel channel) throws PersistentException {
		try {
	...
	public static boolean evict(Channel channel) throws PersistentException {
		try {
