...
public class ProjectEAPersistentManager extends PersistentManager {
	...
	private ProjectEAPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(Category.class);
		aMetadataSources.addAnnotatedClass(Comment.class);
		aMetadataSources.addAnnotatedClass(Article.class);
		aMetadataSources.addAnnotatedClass(Channel.class);
		aMetadataSources.addAnnotatedClass(Suggestion.class);
		aMetadataSources.addAnnotatedClass(ChannelSuggestion.class);
		aMetadataSources.addAnnotatedClass(ArticleSuggestion.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProjectEAPersistentManager();
		}
