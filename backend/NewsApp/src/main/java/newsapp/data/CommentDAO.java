...
public class CommentDAO {
	...
	public static boolean deleteAndDissociate(Comment comment)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(Comment comment, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (comment.getArticle() != null) {
				comment.getArticle()._comments.remove(comment);
			}
