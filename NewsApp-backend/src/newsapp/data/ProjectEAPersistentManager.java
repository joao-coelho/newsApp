...
public class ProjectEAPersistentManager extends PersistentManager {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(newsapp.Channel.class);
		...
		aMetadataSources.addAnnotatedClass(newsapp.User.class);
		aMetadataSources.addAnnotatedClass(newsapp.ChannelCategory.class);
		aMetadataSources.addAnnotatedClass(newsapp.Category.class);
		aMetadataSources.addAnnotatedClass(newsapp.ArticleCategory.class);
	}
