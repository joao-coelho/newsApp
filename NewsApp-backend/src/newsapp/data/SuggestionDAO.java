...
public class SuggestionDAO {
	...
	public static Suggestion loadSuggestionByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Suggestion) session.load(newsapp.Suggestion.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Suggestion getSuggestionByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Suggestion) session.get(newsapp.Suggestion.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Suggestion loadSuggestionByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Suggestion) session.load(newsapp.Suggestion.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Suggestion getSuggestionByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Suggestion) session.get(newsapp.Suggestion.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List querySuggestion(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From newsapp.Suggestion as Suggestion");
		if (condition != null)
	...
	public static Suggestion createSuggestion() {
		return new newsapp.Suggestion();
	}
	
	public static boolean save(newsapp.Suggestion suggestion) throws PersistentException {
		try {
	...
	public static boolean delete(newsapp.Suggestion suggestion) throws PersistentException {
		try {
	...
	public static boolean refresh(newsapp.Suggestion suggestion) throws PersistentException {
		try {
	...
	public static boolean evict(newsapp.Suggestion suggestion) throws PersistentException {
		try {
